...
const CtaSection = () => {
  return (
    <section className="relative overflow-hidden border-t border-border px-6 py-28 sm:py-36">
      <div
      ...
      >
        ...
        >
          <div className="relative w-full flex-1">
            ...
            />
            <Button className="absolute right-1.5 top-1/2 -translate-y-1/2 h-10 shrink-0 rounded-xl px-5 text-[11px] font-bold uppercase tracking-wider shadow-md transition-all duration-200 hover:shadow-lg hover:shadow-accent/10 sm:px-6 sm:text-[12px]">
              Join Waitlist
